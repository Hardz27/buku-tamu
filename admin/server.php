							...
							<td width="43%" valign="bottom">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<a href="server.php?module=home">Beranda</a> | <a href="server.php?module=user&act=edituser&id=<?php echo "$_SESSION[namauser]" ?> ">Ganti Password</a> | <a href="logout.php">Logout</a>
										</td>

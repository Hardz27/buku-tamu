...
while ($r=mysqli_fetch_array($tampil))
{
 ...
 <td>$r[nm_galeri]</td>
 <td>$r[tgl_galeri]</td>
 <td><img src='modul/images/$r[gambar]' width='50'></td>
...
<table>
<tr><td>Caption</td>
<input name='date' type='hidden' value=$tanggal />
<td> : <input name='keterangan' type='text' size='35' /></td></tr>
<tr><td>File Gambar</td>
<td> : <input name='image' type='file' size='30' /></td></tr>
